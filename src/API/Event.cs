...
namespace Alloy.API
{
    public delegate void EventHandler<in TArgsType>(TArgsType args) where TArgsType : AlloyEventArgs;

    /// <summary>
    /// Event arguments for Bricklayer events.
    /// </summary>
    public class AlloyEventArgs : EventArgs
    {
        /// <summary>
    ...
    /// <summary>
    /// Represents a collection of event handlers for a certain event.
    /// </summary>
    /// <typeparam name="TArgs">The type of arguments for the handler.</typeparam>
    public class Event<TArgs> : BaseEvent where TArgs : AlloyEventArgs
    {
        ...
        /// </summary>
        private class PrioritizedEventHandler<TArgsType> where TArgsType : AlloyEventArgs
        {
            /// <summary>
